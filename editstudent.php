...
if(isset($_POST['submit']))
{
	...
	$sql = "update student set fullname='$fullname',father='$father',email='$email',mobile='$mobile',gender='$gender',course='$course' where id='$id'";
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<form class="user" method="post" action="./editstudent.php" enctype="multipart/form-data">
					...
					<div class="form-group">
						<input type="email" class="form-control form-control-user" name="email" value="<?php echo $row['email'];?>"    placeholder="Full Name">
					</div>
					<div class="form-group">
